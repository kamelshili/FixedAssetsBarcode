...
using SQLite;
using Constants = FixedAssets_BarCode.Models.Models.Constants;

namespace FixedAssets_BarCode.Services;
public class UserDatabaseController
{
    ...
    {
        return database.Table<UserLogin>().OrderBy(i => i.Name_User).ToListAsync();
    }
